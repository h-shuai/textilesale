CREATE TABLE t_order_info(
        ...
        order_status varchar(1) DEFAULT NULL COMMENT '订单状态 0-订单暂存 1-待备货(提交备货) 2-备货完成 3-备货复核完成 4-重新备货 5-打包完成 6-完成发货',
...
CREATE TABLE t_order_detail_info(
        ...
        stock_status varchar(1) DEFAULT NULL COMMENT '备货状态 备货状态 0-待备货 1-备货中 2-备货完成',
        create_user varchar(100) DEFAULT NULL COMMENT '创建人',
        update_user varchar(100) DEFAULT NULL COMMENT '修改人',
        create_date datetime COMMENT'创建时间',
        update_date datetime COMMENT'修改时间',
...
CREATE TABLE t_order_stock_detail_info(
        ...
        update_date datetime COMMENT'修改时间',
        PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 comment ='订单备货详情表';
