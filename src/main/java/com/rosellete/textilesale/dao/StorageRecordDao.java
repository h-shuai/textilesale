...
public interface StorageRecordDao extends BaseRepository<StorageRecord, String> {
    ...
    List<StorageRecord> findByConsignorInfo(String recordNo, String storageType,Integer conszignorNo, String consignor, String consignorPhoneNo,
    ...
    List<StorageRecord> findPagedByConsignorInfo(String recordNo, String storageType,Integer conszignorNo, String consignor, String consignorPhoneNo,
                                                 String consignorType, String industryType,
                                                 @Temporal(TemporalType.TIMESTAMP) Date startDate,
                                                 @Temporal(TemporalType.TIMESTAMP) Date endDate,
    ...
    List<Map<String, String>> findSupplierAndCustomer(String storageType,Integer consignorNo, String consignor, String consignorPhoneNo, String consignorType, String industryType);
