...
public interface StoragePackageInfoDao extends BaseRepository<StoragePackage, Long> {
    ...
    List<StoragePackage> findByRecordNo(Integer recordNo);
    ...
    List<Map<String, Object>> findByConsignorInfo(Integer recordNo, String storageType,Integer conszignorNo, String consignor, String consignorPhoneNo,
    ...
    List<Map<String, Object>> findPageByConsignorInfo(Integer recordNo, String storageType,Integer conszignorNo, String consignor, String consignorPhoneNo,
                                                      String consignorType, String industryType,
                                                      @Temporal(TemporalType.TIMESTAMP) Date startDate,
    ...
    List<StoragePackage> findByPackageNo(Integer recordNo, String packageNo);
